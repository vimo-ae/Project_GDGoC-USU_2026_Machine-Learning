...
with col1:
    ...
    if salary < 30000 or salary > 150000:
        st.warning(
            ...
            f"($30,000–$150,000/tahun). Hasil perkiraan di bawah mungkin menjadi kurang pas atau kurang akurat.Nilai konversi gaji (\\${salary:,.0f}) berada di luar rentang data training model "
        )
